                                ...
                                @forelse ($products as $product)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <img src="{{ asset('images/' . $product->image) }}" alt="{{ $product->name }}" class="w-16 h-16 object-cover rounded-md">
                                        </td>
                                        ...
                                        <!-- Kolom Deskripsi Diperbarui di Sini -->
                                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300 max-w-sm">
                                            <p class="whitespace-normal break-words">{{ $product->description }}</p>
                                        </td>
